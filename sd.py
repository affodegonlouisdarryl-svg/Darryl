...
if z == "D":
    ...
    p.write("Physique, Chimie et Technologie coeff (4)")
    p.write("Anglais coeff (2)")
    p.write("Français coeff (2)")
elif z == "C":
    p = st.container(border=True)
    p.write("Mathématiques coeff (6)")
    p.write("Physique, Chimie et Technologie coeff (5)")
    p.write("Anglais coeff (2)")
    p.write("Français coeff (2)")
elif z == "B":
    p = st.container(border=True)
    p.write("Mathématiques coeff (2)")
    p.write("Physique, Chimie et Technologie coeff (1)")
...
k = st.number_input(label="Votre note de Physique, Chimie et Technologie:", min_value=0.0, max_value=20.0, value=17.0, step=0.25)
...
i = st.number_input(label="Votre note de Mathématiques:", min_value=0.0, max_value=20.0, value=12.0, step=0.25   ) 
